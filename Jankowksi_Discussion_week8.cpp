//Max Jankowski
//CS310 Week 8 Discussion
//Bellevue University
//Example for Chapter 10 Exercise 16
...
public:
    ...
    double timeToFill() const { // calculating how mch time is needed to fill pool
        return waterNeeded() / fillingRate;
    }
    
    double timeToDrain() const { // calculate time needed to completely drain the pool
