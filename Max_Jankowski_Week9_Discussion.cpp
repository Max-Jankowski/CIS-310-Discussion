//Max Jankowski 
//Week 9 discussion, code with errors
//Program written if for chap 11 program exercise 4
#include <iostream>
#include <cmath>  
using namespace std;

//defining Pi here, because for some reason my laptop combiler didn't want to proceed.
...
public:
    cylinderType(double r = 0.0) { //constructor initilizing the radias and height of the cylinder
        radius = r;
